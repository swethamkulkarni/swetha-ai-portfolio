...
const projectsData = {
    ...
    project2: {
        ...
        problems: [
            "Limited training data for specific domain knowledge",
            "Handling ambiguous user queries",
            "Response latency issues in real-time conversations",
            "Managing conversation context over extended interactions"
        ],
        solutions: [
            "Used transfer learning from large pre-trained models (BERT, GPT)",
            "Implemented a hybrid rule-based and ML approach for intent classification",
            "Optimized model inference with ONNX Runtime and quantization",
            "Designed a conversation state management system using Redis"
        ],
        outcomes: [
            "Chatbot successfully handles over 85% of common customer inquiries without human intervention",
            "Average response time reduced to under 500ms",
            "Deployed across web, Slack, and WhatsApp platforms",
            "System continuously improves through feedback loop from user interactions"
        ],
